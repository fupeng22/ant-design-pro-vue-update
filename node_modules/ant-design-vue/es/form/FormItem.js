...
export default {
  ...
  inject: {
    ...
    FormContextProps: { 'default': function _default() {
        return {};
      } },
  ...
  methods: {
    collectContext: function collectContext() {
      if (this.FormContextProps.form && this.FormContextProps.form.templateContext) {
        var templateContext = this.FormContextProps.form.templateContext;
    ...
    renderWrapper: function renderWrapper(prefixCls, children) {
      ...
      var _ref = this.isFormItemChildren ? {} : this.FormContextProps,
    ...
    renderLabel: function renderLabel(prefixCls) {
      ...
      var h = this.$createElement;
      var _FormContextProps = this.FormContextProps,
          vertical = _FormContextProps.vertical,
          contextLabelAlign = _FormContextProps.labelAlign,
          contextLabelCol = _FormContextProps.labelCol,
          contextColon = _FormContextProps.colon;
    ...
    decoratorChildren: function decoratorChildren(vnodes) {
      var FormContextProps = this.FormContextProps;

      var getFieldDecorator = FormContextProps.form.getFieldDecorator;
      for (var i = 0, len = vnodes.length; i < len; i++) {
        var vnode = vnodes[i];
  ...
  render: function render() {
    var $slots = this.$slots,
        ...
        FormContextProps = this.FormContextProps;
